          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                <ul class=" flex gap-x-4 me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <Link  class=" text-gray-300 "  :href="route('home')"> Home</Link>

                    </li>
                    <li class="nav-item">
                        <Link  class="  text-gray-300" :href="route('about')"> About</Link>

                    </li>
                    <li class="nav-item">
                        <Link class="  text-gray-300" :href="route('contact')"> Contact</Link>
